...
if __name__=='__main__': 
    # Example usage
    images_dir = "./datasets/boy_with_thorn/"
    feat_dir = "./datasets/boy_with_thorn/outputs/features/SIFT/"
    matches_dir = "./datasets/boy_with_thorn/outputs/matches/FlannBasedMatcher/"
    out_cloud_dir = "./datasets/boy_with_thorn/output_pcd/point-clouds/"
    out_err_dir = "./datasets/boy_with_thorn/output_pcd/errors/"
    plot_error = True
    cross_check = False
